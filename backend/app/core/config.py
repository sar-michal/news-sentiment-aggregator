...
class Settings(BaseSettings):
    ...
    URL_BLACKLIST: tuple[str, ...] = {
        ...
        "/pidgin/", "/mundo/", "/afrique/", "/espanol/",
        
        # 2. Live Blogs (Fragmented text)
        "/live/", "/liveblog/", "/live-news/", "/live-", 
        
        # 3. Multimedia / Interactive (No prose)
        "/interactive/", "/video/", "/gallery/", "/audio/", "/sounds/",
        "/photos/", "/transcripts/", "/podcasts/"
        
        # 4. Sports (Aggressive vocabulary skews geopolitical sentiment)
        "/sport/", "/sports/",
        
        # 5. Entertainment & Arts
        "/film/", "/music/", "/tv-and-radio/", "/books/", "/games/", 
        "/entertainment/", "/arts/", "/culture/",
        
        # 6. Lifestyle / Fluff / Affiliate Marketing
        "/lifeandstyle/", "/food/", "/style/", "/travel/", "/health/", 
        "/tiny-happy-people/", "/select/", "/wellness/", "/recipes/", "/coupons/",
        
        # 7. Opinion Pieces & Editorials (Highly subjective/biased)
        "/commentisfree/", "/opinion/", "/opinions/", "/editorials/"
